...
function UpAndDown (props) {
  return <svg width="10px" height="20px" viewBox="0 0 300 300" {...props}>
    <g>
      ...
      <path transform="translate(0 200)" d="M282.082,76.511l-14.274-14.273c-1.902-1.906-4.093-2.856-6.57-2.856c-2.471,0-4.661,0.95-6.563,2.856L142.466,174.441
...
function Up (props) {
  return <svg style={{position: 'relative', top: '2.5px'}} width="10px" height="10px" viewBox="0 0 284.929 284.929" {...props}>
    <g>
      <path d="M282.082,195.285L149.028,62.24c-1.901-1.903-4.088-2.856-6.562-2.856s-4.665,0.953-6.567,2.856L2.856,195.285
        C0.95,197.191,0,199.378,0,201.853c0,2.474,0.953,4.664,2.856,6.566l14.272,14.271c1.903,1.903,4.093,2.854,6.567,2.854
        c2.474,0,4.664-0.951,6.567-2.854l112.204-112.202l112.208,112.209c1.902,1.903,4.093,2.848,6.563,2.848
